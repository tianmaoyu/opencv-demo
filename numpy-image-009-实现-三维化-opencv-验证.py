...
# 只是直接推导得到的
homography_matrix2=np.array([
    [2.725597628882036, 1.341739620879649, -3451.1947799828786],
    [1.7108785121095928e-16, 5.953710807341146, -2198.8945644568926],
    [-0.0, 0.0006708696501870143, 1.0]
])
print(homography_matrix.tolist())
print(homography_matrix2.tolist())
homography_matrix=homography_matrix2
...
# 保存图像
cv2.imwrite('pixel_to_gen_img/numpy-image8-opencv验证.png', rotated_img)
exit(1)